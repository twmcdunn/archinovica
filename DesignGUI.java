...
public class DesignGUI extends JPanel implements KeyListener, ActionListener, MouseMotionListener, MouseListener {
    ...
    public MenuBar createMenu() {
        ...
        String[] items3 = { "Create Highlighted Group", "Stop Highlighting", "Delete Highlighted Group",
                "Add Progression Pitches" };
    ...
    class CompositionSpace {
        ...
        public void setCursorToNearestGroup(int dispX, int dispY) {
            if (focusObject.mySubgroups.size() <= 1)//if the user is dumb, hehe
                moveBySubgroups = false;
        ...
        public void highlightProgression() {
            ...
            if (highlightedProgressionName.equals("NEW")) {
                ...
                int index = 1;
                while (index < highlightGroupNames.length
                        && !highlightGroupNames[index].equals(highlightedProgressionName))
                    index++;
        ...
        public void calculatePedals() {
            ...
            for (int index = 0; index < size(); index++) {
                ...
                if (!areFormallyEqual(progressionArray, archiArray)) {
                    JOptionPane optionPane = new JOptionPane();
                    optionPane.showMessageDialog(DesignGUI.this,
                            "Warning: no solution @ index.\nChord violates wellformedness." + index);
                    return;
                }
                ...
                if (progressionPointOfReference != null) {
                    int[] progressionTransformation = progressionPointOfReference
                            .getTransformation(progressionDestination);
                    ...
                    for (int i = 1; !equalTransforms && i < 4; i++) {
                        ...
                        progressionTransformation = progressionPointOfReference
                                .getTransformation(progressionDestination);
